...
C {devices/lab_wire.sym} 410 -420 0 1 {name=p10 sig_type=std_logic lab=ASIG}
C {devices/lab_wire.sym} 140 -420 0 0 {name=p11 sig_type=std_logic lab=pad}
C {noconn.sym} 110 -420 0 0 {name=l3}
C {/foss/designs/sscs-chipathon-2025/resources/Integration/Chipathon2025_pads/xschem/asig5V.sym} 150 -340 0 0 {name=X1}
